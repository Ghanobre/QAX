...
resultanalise =list(pd.read_excel('C:\QAX\Projects\Python\Fixtures\Lotofacil.xlsx',skiprows=3076, usecols="C:Q"))
...
for elemento in array1:
    if elemento in resultanalise:
        posicoes_encontradas +=1
print('Jogo1 Gus',resultanalise,posicoes_encontradas)

posicoes_encontradas = 0
for elemento in array2:
    if elemento in resultanalise:
        posicoes_encontradas +=1
print('Jogo2 Gus',resultanalise,posicoes_encontradas)

posicoes_encontradas = 0
for elemento in array3:
    if elemento in resultanalise:
        posicoes_encontradas +=1
print('Jogo1 Ana',resultanalise,posicoes_encontradas)

posicoes_encontradas = 0
for elemento in array4:
    if elemento in resultanalise:
        posicoes_encontradas +=1
print('Jogo2 Ana',resultanalise,posicoes_encontradas)